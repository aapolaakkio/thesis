...
Distances are not modelled: a ride occupies its duration $R_i$ and travel between drop-off and the next pickup is approximated by the minimum break $B_{\min}$.
